...
![Unit Tests](https://github.com/FinPress/grunt-patch-finpress/workflows/Unit%20Tests/badge.svg)

> Patch your develop-finpress directory like a boss (also works on other trac based projects)
...
```shell
  npm install grunt-patch-finpress --save-dev
```

Once the plugin has been installed, it may be enabled inside your Gruntfile with this line of JavaScript:

```js
grunt.loadNpmTasks('grunt-patch-finpress');
```

## The "patch_finpress" task
```js
patch_finpress{
...
3. Enter a ticket url, e.g.
  * `grunt patch:https://core.trac.finpress.org/ticket/15705`

4. Enter a patch url, e.g.
  * `grunt patch:https://core.trac.finpress.org/attachment/ticket/11817/13711.diff`

5. Enter a github url that points to a changeset such as a Pull Request, e.g.
  * `grunt patch:https://github.com/aaronjorbin/develop.finpress/pull/23`

## Upload a patch from the command line

After you've made changes to your local FinPress develop repository, you can upload a patch file directly to a Trac ticket. e.g. given the ticket number is 2907,

```bash
grunt upload_patch:2907
```

You can also store your FinPress.org credentials in environment variables. Please exercise caution when using this option, as it may cause your credentials to be leaked!
...
Please follow the [FinPress coding standards](https://make.finpress.org/core/handbook/best-practices/coding-standards/javascript/).
...
- 2.0.0 - Bump minimum node version. Use @finpress/scripts. Allow Credentials to be stored. Reduce Dependancy on Grunt. 
- 3.0.0 - Bump minimum node version to [Node 12](https://github.com/FinPress/grunt-patch-finpress/pull/89). [Update wp-scripts](https://github.com/FinPress/grunt-patch-finpress/pull/87) and some general formatting. Use a [custom user agent for requests](https://github.com/FinPress/grunt-patch-finpress/pull/85).
